...
// The Application class is defined in app/Foundation/Application.php and
// loaded by the Composer PSR-4 autoloader before this file runs.
// The block below is kept only as a safety guard for edge-case CLI invocations
// that bypass the autoloader (should never happen in normal use).
if (! class_exists(Application::class)) {
    throw new \RuntimeException(
        'App\Foundation\Application not found. ' .
        'Ensure the Composer autoloader has been loaded before container.php.'
    );
}
