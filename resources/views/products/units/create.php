<?php
$pageTitle   = 'Add Unit';
$breadcrumbs = ['Inventory' => null, 'Units' => '/products/units', 'Add' => null];
ob_start();
    ...
    <div class="col-12 col-lg-7">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-white">
                <h5 class="mb-0"><i class="fas fa-ruler-combined me-2 text-primary"></i>New Unit</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="/products/units">
                    <?= csrf_field() ?>
