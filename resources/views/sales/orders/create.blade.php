...
<div class="d-flex align-items-center gap-2 mb-4">
    ...
    <h5 class="mb-0 fw-semibold">New Sales Order</h5>
</div>
                        ...
                        <table class="table mb-0" id="itemsTable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="number" name="items[0][quantity]" class="form-control form-control-sm qty" min="1" step="1" value="1" required style="width:80px"></td>
...
document.querySelector('#itemsTable').addEventListener('input', e => {
    ...
    if (e.target.classList.contains('product-select')) {
        ...
        if (opt && opt.dataset.vat) row.querySelector('input[name*="vat_percent"]') && (row.querySelectorAll('input')[2].value = opt.dataset.vat);
        recalcRow(row);
    }
});
