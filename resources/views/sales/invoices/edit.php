...
<div class="card shadow-sm">
    <div class="card-header bg-white border-bottom">
        <h5 class="mb-0"><i class="fas fa-file-invoice me-2 text-primary"></i>Edit Invoice
            <span class="badge bg-secondary ms-2"><?= sanitize($invoice['reference_no'] ?? '') ?></span>
        </h5>
    </div>
    <div class="card-body">
        ...
        <form method="POST" action="/sales/invoices/<?= (int) $invoice['id'] ?>" id="invoice-form">
            <?= csrf_field() ?>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" name="due_date" class="form-control <?= isset($errors['due_date']) ? 'is-invalid' : '' ?>"
                           value="<?= sanitize($old['due_date'] ?? '') ?>" required>
                    ...
                    <tbody id="items-container">
                        ...
                        <tr class="item-row">
                            ...
                            <td><input type="text" name="items[<?= $idx ?>][description]" class="form-control form-control-sm"
                                       value="<?= sanitize($item['description'] ?? '') ?>"></td>
                            ...
                            <td><input type="number" name="items[<?= $idx ?>][discount]" class="form-control form-control-sm item-disc"
                                       step="0.01" min="0" max="100" value="<?= (float) ($item['discount'] ?? 0) ?>"></td>
                            <td class="text-end">
                ...
                <div class="col-md-4">
                    <table class="table table-sm">
                        <tr>
                            ...
                            <td class="text-end fw-semibold" id="summary-subtotal"><?= number_format((float) ($invoice['subtotal'] ?? 0), 2) ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-end" id="summary-tax"><?= number_format((float) ($invoice['tax_amount'] ?? 0), 2) ?></td>
                        </tr>
                        <tr class="fw-bold border-top">
                            <td>Total</td>
                            <td class="text-end text-primary fs-5" id="summary-total"><?= number_format((float) ($invoice['total'] ?? 0), 2) ?></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="d-flex gap-2 justify-content-end">
                <a href="/sales/invoices/<?= (int) $invoice['id'] ?>" class="btn btn-secondary">Cancel</a>
