...
<div class="card shadow-sm">
    <div class="card-header bg-white border-bottom">
        <h5 class="mb-0"><i class="fas fa-file-alt me-2 text-primary"></i>New Quotation</h5>
    </div>
    <div class="card-body">
        ...
        <form method="POST" action="/sales/quotations" id="quotation-form">
            <?= csrf_field() ?>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" name="expiry_date" class="form-control <?= isset($errors['expiry_date']) ? 'is-invalid' : '' ?>"
                           value="<?= sanitize($old['expiry_date'] ?? date('Y-m-d', strtotime('+30 days'))) ?>">
            ...
            <div class="d-flex gap-2 justify-content-end">
                <a href="/sales/quotations" class="btn btn-secondary">Cancel</a>
