    ...
    <div class="col-12 col-lg-8">
        <div class="card shadow-sm">
            <div class="card-header">
                <h5 class="card-title mb-0"><i class="fas fa-calendar-plus me-2"></i>Add Attendance Record</h5>
            </div>
            <div class="card-body">
                ...
                <form method="POST" action="/attendance">
                        ...
                        <select id="employee_id" name="employee_id"
                            ...
                            <?php foreach ($employeeList as $emp): ?>
                                <option value="<?= (int) $emp['id'] ?>"
                                    <?= ((int) ($old['employee_id'] ?? 0)) === (int) $emp['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="notes" name="notes" class="form-control" rows="2"><?= sanitize($old['notes'] ?? '') ?></textarea>
                    </div>

                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i>Create Record</button>
