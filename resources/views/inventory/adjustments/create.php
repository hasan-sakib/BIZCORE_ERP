...
$breadcrumbs = ['Inventory' => null, 'Adjustments' => '/inventory/adjustments', 'New' => null];
ob_start();
...
<form method="POST" action="/inventory/adjustments" id="adjustmentForm">
    <?= csrf_field() ?>
    ...
    <div class="row g-4">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-2 mb-2 d-none d-md-flex">
                        <div class="col-md-4"><span class="form-label fw-semibold small">Product</span></div>
                        <div class="col-md-2"><span class="form-label fw-semibold small">Type</span></div>
                        <div class="col-md-2"><span class="form-label fw-semibold small">Quantity</span></div>
                        <div class="col-md-3"><span class="form-label fw-semibold small">Item Reason</span></div>
                    ...
                    <div id="items-container">
                        <div class="item-row row g-2 mb-2 align-items-center" data-index="0">
                            ...
                            <div class="col-md-2">
                                <select name="items[0][type]" class="form-select form-select-sm" required>
                            ...
                            <div class="col-md-3">
                                <input type="text" name="items[0][item_reason]"
                                       class="form-control form-control-sm"
                                       placeholder="Item-level reason (optional)">
                            </div>
                            <div class="col-md-1">
        ...
        <div class="col-12 d-flex gap-2">
            ...
            <a href="/inventory/adjustments" class="btn btn-outline-secondary">Cancel</a>
        </div>
    </div>
</form>
