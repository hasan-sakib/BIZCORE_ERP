...
$breadcrumbs = ['Inventory' => null, 'Stock In' => '/inventory/stock-in', 'New' => null];
ob_start();
...
<form method="POST" action="/inventory/stock-in" id="stockInForm">
    <?= csrf_field() ?>
    ...
    <div class="row g-4">
        ...
        <div class="col-12 d-flex gap-2">
            ...
            <a href="/inventory/stock-in" class="btn btn-outline-secondary">Cancel</a>
        </div>
    </div>
</form>
