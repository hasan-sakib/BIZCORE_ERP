...
$breadcrumbs = ['Inventory' => null, 'Stock In' => '/inventory/stock-in', sanitize($order['reference_no'] ?? '') => null];
$headerActions = '<a href="/inventory/stock-in/' . (int) ($order['id'] ?? 0) . '/pdf" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="col-12 col-md-7">
        <div class="card shadow-sm">
            <div class="card-header bg-white">
                <h6 class="mb-0"><i class="fas fa-arrow-down me-2 text-success"></i>Stock In Details</h6>
            </div>
            <div class="card-body">
                <dl class="row mb-0">
                    ...
                    <dd class="col-sm-8"><?= sanitize($order['date']) ?></dd>
    ...
    <div class="col-12 col-md-5">
        <div class="card shadow-sm h-100">
            ...
            <div class="card-body d-flex flex-column justify-content-center text-center">
                <div class="display-6 fw-bold text-success">৳<?= number_format((float) ($order['total_amount'] ?? 0), 2) ?></div>
