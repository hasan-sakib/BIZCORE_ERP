...
$breadcrumbs = ['Purchasing' => null, 'Orders' => '/purchasing/orders', 'New' => null];
ob_start();
...
<form method="POST" action="/purchasing/orders" id="poForm">
    <?= csrf_field() ?>
    ...
    <div class="row g-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date"
                                   ...
                                   value="<?= sanitize($old['order_date'] ?? date('Y-m-d')) ?>"
                                   required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date"
                                   ...
                                   name="expected_date"
                                   class="form-control"
                                   value="<?= sanitize($old['expected_date'] ?? '') ?>">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number"
                                   ...
                                   class="form-control"
                                   value="<?= sanitize($old['discount_percent'] ?? '0') ?>"
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number"
                                   ...
                                   name="tax_percent"
                                   class="form-control"
                                   value="<?= sanitize($old['tax_percent'] ?? '0') ?>"
                                   min="0" max="100" step="0.01"
                                   placeholder="0.00">
                        </div>
        ...
        <div class="col-12 d-flex gap-2">
            ...
            <a href="/purchasing/orders" class="btn btn-outline-secondary">Cancel</a>
        </div>
    </div>
</form>
